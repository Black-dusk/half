			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="form-horizontal">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="email_add_input"
									name="email" placeholder="请输入数字"> <span
									class="help-block"></span>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label for="inputdept" class="col-sm-2 control-label">地址</label>
							<div class="col-sm-4">
	...
	<script type="text/javascript">
		...
		function validate_add_form() {
			...
			if (!regEmail.test(email)) {
				//alert("年龄格式输入错误");
				show_validate_msg("#email_add_input", "error", "年龄格式输入错误");
				//$("#email_add_input").parent().addClass("has-error");
				//$("#email_add_input").next("span").text("年龄格式输入错误");
				return false;
			} else {
		...
		$("#emp_update_btn").click(function() {
			...
			var regEmail = /^[0-9]*$/;
			if (!regEmail.test(email)) {
				show_validate_msg("#email_update_input", "error", "年龄格式输入错误");
				return false;
			} else {
