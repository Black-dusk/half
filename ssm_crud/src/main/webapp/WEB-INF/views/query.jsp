		...
		function getDepts(ele) {
			...
			$.ajax({
				...
				success : function(result) {
					...
					//{"code":100,"msg":"处理成功","extend":{"depts":[{"deptId":1,"deptName":"云南省"},{"deptId":2,"deptName":"测试部"},{"deptId":3,"deptName":"财务部"},{"deptId":4,"deptName":"秘书部"},{"deptId":5,"deptName":"后勤部"},{"deptId":6,"deptName":"总务处"}]}}
					//console.log(result);
					//提取地址信息显示在下拉列表中
